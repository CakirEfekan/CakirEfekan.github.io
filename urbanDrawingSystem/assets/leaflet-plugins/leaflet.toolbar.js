  ...
  ;(t.L.Toolbar2 = (L.Layer || L.Class).extend({
    ...
    onAdd: function (t) {
      ...
      0 === this._calculateDepth() &&
        (o && t.removeLayer(o), (t._toolbars[this._toolbar_type] = this))
    },
    onRemove: function (t) {
    ...
    appendToContainer: function (t) {
      ...
      for (
        this._container = t,
          this._ul = L.DomUtil.create('ul', s, t),
      ...
      for (o = 0, e = this.options.actions.length; o < e; o++)
        new (this._getActionConstructor(this.options.actions[o]))()._createIcon(
          this,
          this._ul,
          this._arguments
        )
    ...
    _getActionConstructor: function (t) {
      ...
      return t.extend({
        ...
        enable: function (o) {
          i._active && i._active.disable(),
            (i._active = this),
            t.prototype.enable.call(this, o)
        }
      })
    },
    _hide: function () {
    ...
    _calculateDepth: function () {
      for (var t = 0, o = this.parentToolbar; o; )
        (t += 1), (o = o.parentToolbar)
      return t
    }
  })),
  ...
  ;(L.Toolbar2.extend = function (t) {
    ...
    (L.Toolbar2.Action = L.Handler.extend({
      ...
      initialize: function (t) {
        ...
        L.setOptions(this, t),
          (this.options.toolbarIcon = L.extend({}, o, this.options.toolbarIcon))
      },
      enable: function (t) {
    ...
    (L.Toolbar2.Popup = L.Toolbar2.extend({
      ...
      initialize: function (t, o) {
        L.Toolbar2.prototype.initialize.call(this, o),
      ...
      _setStyles: function () {
        for (
          var t,
            ...
            e = this._container,
            n = this._ul,
            s = L.point(this.options.anchor),
            a = n.querySelectorAll('.leaflet-toolbar-icon'),
            l = [],
            r = 0,
            c = 0,
            h = a.length;
          ...
          a[c].parentNode.parentNode === n &&
            (l.push(parseInt(L.DomUtil.getStyle(a[c], 'height'), 10)),
            (r += Math.ceil(parseFloat(L.DomUtil.getStyle(a[c], 'width')))),
            (r += Math.ceil(
              parseFloat(L.DomUtil.getStyle(a[c], 'border-right-width'))
            )))
        ;(n.style.width = r + 'px'),
          ...
          (this._tipContainer.style.width =
            r +
            Math.ceil(parseFloat(L.DomUtil.getStyle(n, 'border-left-width'))) +
            'px'),
